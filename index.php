    ...
    <main>
        ...
        <div class="grid cards">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="./Viagem/home_viagem.html" class="btn secondary"
                >Ver detalhes</a
              >
            </div>
          </div>
      ...
      <section class="section alt">
        <div class="section-head">
          ...
          <a
            href="./Comunidade/home_comunidade.html"
            class="link"
            style="
              color: rgb(255, 103, 1);
              font-weight: bold;
        ...
        <div class="testimonial-grid">
          <div class="testimonial-card">
            ...
            <p class="quote">
              "Experiência incrível, viagem impecável! A WonderFly cuidou de
              tudo, os guias locais eram fantásticos e o roteiro foi
              diferenciado."
            </p>
            <div class="profile">
              <img
                src="https://randomuser.me/api/portraits/women/68.jpg"
                alt="Foto de Ana Ribeiro"
              />
              <div class="profile-info">
                <h4>Ana Ribeiro</h4>
                <span>Viagem: <strong>Safari na Tanzânia</strong></span>
              </div>
            </div>
          </div>
          ...
          <div class="testimonial-card">
            ...
            <p class="quote">
              "A melhor agência para quem busca imersão cultural. O festival
              Holi na Índia foi algo que jamais esquecerei. Seguro e autêntico."
            </p>
            <div class="profile">
              <img
              ...
              <div class="profile-info">
                <h4>Carlos Mendes</h4>
                <span>Viagem: <strong>Holi na Índia</strong></span>
              </div>
            </div>
          </div>
          ...
          <div class="testimonial-card">
            ...
            <p class="quote">
              "Fiz o roteiro do Marrocos e foi espetacular. Grupos pequenos
              realmente fazem a diferença. Recomendo 100%!"
            </p>
            <div class="profile">
              <img
              ...
              <div class="profile-info">
                <h4>Juliana Costa</h4>
                <span>Viagem: <strong>Marrocos Essencial</strong></span>
              </div>
            </div>
          </div>
        </div>
