...
<section class="section trip-details" id="trip-details-content">
    <div class="details-grid">
        <main class="main-content">
            ...
            <?php 
                // Imprime a descrição longa do banco
                echo $viagem['descricao_longa'] ?? '<p>Descrição detalhada em breve.</p>'; 
            ?>

            <div class="included">
                <?php 
                    // Imprime o HTML do "Incluso" do banco
            ...
            <div class="not-included">
                <?php 
                    // Imprime o HTML do "Não Incluso" do banco
            ...
            <div class="itinerary">
                <?php 
                    // Imprime o HTML do "Itinerário" do banco
             ...
             <div class="accommodation">
                <?php 
                    // Imprime o HTML da "Hospedagem" do banco
